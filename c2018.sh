...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://www.dropbox.com/s/fqao28jl2vt7o9t/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://www.dropbox.com/s/pf9mpn99wi74l00/badvpn-udpgw64"
fi
...
echo "PPTP VPN    : 1732"
echo "Nginx       : 85"
echo -e "Fail2Ban    : \e[3;33;32m[ON >> PROTECTED]\e[0m"  
echo -e "AntiDDOS    : \e[3;33;32m[ON >> PROTECTED]\e[0m"  
echo -e "AntiTorrent : \e[3;33;32m[ON >> PROTECTED]\e[0m"
